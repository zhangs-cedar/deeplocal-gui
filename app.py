...
def main():
    ...
    with Blocks(theme='light') as blocks:
        ...
        with Header() as header:
            ...
            # 点击按钮切换页面
            header.addCenter(Button("页面1", variant='text', on_click=on_title_click))
            header.addCenter(Button("页面2", variant='text', on_click=on_title_click))
            header.addCenter(Button("页面3", variant='text', on_click=on_title_click))
